...
<label for="Admin"><h2><b>New Requests</b></h2></label>
<th>Date/Time</th>
<th>Order</th>
<th>First Name</th>
<th>Last Name</th>
...
echo '<tr onClick="HighLightTR(this);"><td>'.$line['Date&Time'].'</td><td>'.$line['order_id'].'</td><td>'.$line['fname'].'</td><td> '.$line['lname'].'</td><td>'. $line['item'].' </td><td>'.$line['Rental_term'].'</td><td>'.$line['pnumber'].'</td><td>'.$line['email'].'</td><td>'.$line['desired'].'</td></tr>';
...
<label for="Admin"><br><h2><b>Emailed Orders</b></h2></label>
<th>Date/Time</th>
<th>Order</th>
<th>First Name</th>
<th>Last Name</th>
...
while ($line = mysql_fetch_assoc($resultemailed_orders)){
echo '<tr onClick="HighLightTR(this);"><td>'.$line['Date&Time'].'</td><td>'.$line['order_id'].' </td><td>'.$line['fname'].'  </td><td>'.$line['lname'].' </td><td>'. $line['item'].' </td><td>'.$line['Rental_term'].'
	</td><td>'.$line['pnumber'].' </td><td>'.$line['email'].'</td><td>'.$line['desired'].'</td></tr>';
}
?>
