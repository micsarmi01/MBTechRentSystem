...
//comp orders
$comporders = "select * from orders where comp='1' and returned=1 or comp='1' and checkedout=1 ";
$compall_orders= mysql_query($comporders,$dblink);
//mac orders
...
<div align="left">
<label for="Admin" align ="bottom"><h2><b>COMP ORDERS:</b></h2></b></label></div>

<th>
<?php

while ($line = mysql_fetch_assoc($compall_orders)){
