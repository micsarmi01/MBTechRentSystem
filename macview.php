...
//countrow
$resultcount = mysql_query("SELECT * FROM orders where item like'Macbook' and returned=1 or item like'Macbook' and checkedout=1 ", $dblink);
$num_rows = mysql_num_rows($resultcount);
$outresultcount = mysql_query("SELECT * FROM orders where item like'Macbook' and checkedout=1 ", $dblink);
$outnum_rows = mysql_num_rows($outresultcount);
////////////////////////  Check Out Function //////////////////////////////////
...
?></span></a></li>
    ...
    <!-- ///////////////////////////////////////   Projector  /////////////////////////////////////////      --> 
     <li class='has-sub'><a href='#'><span>Projector</span></a>
      <ul>
         <li class='last'><a href='#'><span><?php
...
<div align="center">
Projector:';
while ($line = mysql_fetch_assoc($projectortotal)){
echo' </br>
'.$line['serial_number'].'';
}'</div>';
?></span></a></li>
...
<!-- //////////////////////////////////////////////////////                     /////////////////////////////////////////////////////////////// -->
<table>
<th>  Number of Total Mac Orders  </th>
<tr>
...
<th>   Mac Orders Checked Out </th>
<tr>
<td align='center' width='200' >
<?php
echo "  &nbsp&nbsp $outnum_rows &nbsp&nbsp ";
?>
</td>
</tr>
...
echo "<table>";  
echo "<tr>";  
echo "<th>Sum of total MacBook orders</th>";  
$result = mysql_query("SELECT SUM(amtPaid)   
FROM orders  
WHERE item like'Macbook' and returned=1 or item like'Macbook' and checkedout=1");  
...
<label for="Admin"><center><h2><b>Mac Book Orders</b></h2><center></label>
...
while ($line = mysql_fetch_assoc($macall_orders)){
