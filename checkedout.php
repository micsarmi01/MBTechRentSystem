...
//countrow
$resultcount = mysql_query("SELECT * FROM orders where checkedout=1 ", $dblink);
...
<!-- //////////////////////////////////////////////////////                     /////////////////////////////////////////////////////////////// -->
<table>
<th>  Number of Total Checked out Orders </th>
<tr>
...
<div align="left">
<label for="Admin" align ="bottom"><center><h2><b>Checked Out Orders</b></h2><center></label></div>
<th>Order</th>
<th>First Name</th>
<th>Last Name</th>
<th>Item</th>
...
while ($line = mysql_fetch_assoc($resultrented_orders)){
echo '<tr onClick="HighLightTR(this);"><td>'.$line['order_id'].' </td><td>'.$line['fname'].'  </td><td>'.$line['lname'].' </td><td>'. $line['item'].' </td><td>'.$line['Rental_term'].'
	</td><td>'.$line['pnumber'].' </td><td>'.$line['email'].'</td><td>'.$line['serialnumber'].'</td><td>'.$line['amtPaid'].'</td><td>'.$line['returndate'].'</td><td>'.$line['dateout'].'</td></tr>';
}
?>
