...
<div class="orders">
<table class="hoverTable" id="display" align="left" width=100% border="3" cellpadding ="7" cellspacing ="7" text-align:"left" top:"500px">
<form id="scheduled_form" action="<?= $_SERVER['PHP_SELF'] ?>" method='post'>
<div align="left">
<label for="Admin"><center><h2><b>Scheduled for Pick Up</b></h2><center></label></div>
<th>Order</th>
<th>First Name</th>
<th>Last Name</th>
<th>Item</th>
...
<th>Phone Number</th>
<th>Email</th>
<th>Pick Up Appointment</th>


<?php

while ($line = mysql_fetch_assoc($resultscheduled_orders)){
echo '<tr onClick="HighLightTR(this);"><td>'.$line['order_id'].' </td><td>'.$line['fname'].'  </td><td>'.$line['lname'].' </td><td>'. $line['item'].' </td><td>'.$line['Rental_term'].'
	</td><td>'.$line['pnumber'].' </td><td>'.$line['email'].'</td><td>'.$line['appointment'].'</td></tr>';
}
?>
