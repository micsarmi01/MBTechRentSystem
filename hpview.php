...
//hplaptop
$hporders = "select * from orders where item like'HP Laptop' and returned=1 or item like'HP Laptop' and checkedout=1 ";
$hpall_orders= mysql_query($hporders,$dblink);
//countrow
$resultcount = mysql_query("SELECT * FROM orders where item like'HP Laptop' and returned=1 or item like'HP Laptop' and checkedout=1 ", $dblink);
...
echo "<table>";  
echo "<tr>";  
echo "<th>Sum of total HP Laptop orders</th>";  
$result = mysql_query("SELECT SUM(amtPaid)   
FROM orders  
WHERE item like'HP Laptop' and returned=1 or item like'HP Laptop' and checkedout=1");  
...
<label for="Admin"><center><h2><b>HP Orders</b></h2><center></label>
...
while ($line = mysql_fetch_assoc($hpall_orders)){
