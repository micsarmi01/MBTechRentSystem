...
//projector
$projectororders = "select * from orders where item like'projector' and returned=1 or item like'projector' and checkedout=1 ";
$projectorall_orders= mysql_query($projectororders,$dblink);
//countrow
$resultcount = mysql_query("SELECT * FROM orders where item like'projector' and returned=1 or item like'projector' and checkedout=1 ", $dblink);
...
<!-- //////////////////////////////////////////////////////                     /////////////////////////////////////////////////////////////// -->
<table>
<th>  Number of Total HP Laptop Orders  </th>
<tr>
...
echo "<table>";  
echo "<tr>";  
echo "<th>Sum of total Projecor orders</th>";  
$result = mysql_query("SELECT SUM(amtPaid)   
FROM orders  
WHERE item like'projector' and returned=1 or item like'projector' and checkedout=1");  
...
<label for="Admin"><center><h2><b>Projector Orders</b></h2><center></label>
...
while ($line = mysql_fetch_assoc($projectorall_orders)){
